...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.sample.basicwebsite.WebSite} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WebSiteItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WebSite_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WebSite_name_feature", "_UI_WebSite_type"),
						BasicwebsitePackage.Literals.WEB_SITE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BasicwebsitePackage.Literals.WEB_SITE__PAGES);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_WebSite_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(BasicwebsitePackage.Literals.WEB_SITE__PAGES,
				BasicwebsiteFactory.eINSTANCE.createPage()));
	}
