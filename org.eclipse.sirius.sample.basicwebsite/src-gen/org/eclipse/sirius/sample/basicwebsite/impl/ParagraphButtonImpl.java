...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Paragraph Button</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.basicwebsite.impl.ParagraphButtonImpl#getParagraph <em>Paragraph</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphButtonImpl extends ButtonImpl implements ParagraphButton {
	/**
	...
	protected EClass eStaticClass() {
		return BasicwebsitePackage.Literals.PARAGRAPH_BUTTON;
	}
			...
			if (paragraph != oldParagraph) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							BasicwebsitePackage.PARAGRAPH_BUTTON__PARAGRAPH, oldParagraph, paragraph));
			}
		}
		return paragraph;
	}
	...
	public void setParagraph(Paragraph newParagraph) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicwebsitePackage.PARAGRAPH_BUTTON__PARAGRAPH,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BasicwebsitePackage.PARAGRAPH_BUTTON__PARAGRAPH:
			if (resolve)
				return getParagraph();
